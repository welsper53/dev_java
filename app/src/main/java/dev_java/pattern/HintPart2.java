...
public class HintPart2 {
    ...
    public static void main(String[] args) {
        HintPart2 hintPart2 = new HintPart2();
        Scanner s = new Scanner(System.in);
        String result;

        // [난수 채번]
        hintPart2.ranCom();
        System.out.println("** 채번값 : " + hintPart2.com[0] + hintPart2.com[1] + hintPart2.com[2] + " **");
