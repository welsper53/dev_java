...
public class RandomGameLogic {
    ...
    public String account(String user) {
        ...
        for (int i = 0; i < com.length; i++) {
            ...
            } // end of inner for문 - 같은 자리수인지 확인
        } // end of outter for문 - 숫자가 일치하는지 확인
    ...
    }   // end of method - 난수값과 입력값이 동일한지 확인
    ...
    public void gamePlay() {
        ...
        // [난수 채번]
        ranCom();
        System.out.println("** 채번값 : " + com[0] + com[1] + com[2] + " **");
