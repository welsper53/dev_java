...
package dev_java.weak4.d221219;
...
public class DeptTable7 extends JFrame implements ActionListener { // DeptTable7 is a JFrame
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // 너 상세보기 원해?
            ...
            // 테이블의 양식 폼인 JTable 이벤트로 얻어옴
            String[] oneRow = vdata.get(index);
            jtd7.set("상세보기", true, oneRow, index);
            jtd7.jbtn_save.setEnabled(false);
            jtd7.jtf_deptno.setEnabled(false);
            jtd7.jtf_dname.setEnabled(false);
            jtd7.jtf_loc.setEnabled(false);
        }
