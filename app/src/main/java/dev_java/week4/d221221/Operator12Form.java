package dev_java.week4.d221221;
...
public class Operator12Form implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (jbtn_account == obj) {// 연산 버튼
            ...
            switch(jlb_oper.getText()) {
                case "+": {
                    jtf_result.setText(" = " + Double.toString(account("+")));
                    break;
                }
                case "-": {
                    jtf_result.setText(" = " + Double.toString(account("-")));
            ...
            // insert here
            jlb_oper.setText(jbtn_plus.getText());
        } else if (jbtn_minus == obj) {// 빼기 연산자
            // insert here
            jlb_oper.setText(jbtn_minus.getText());
        } else if (jbtn_mult == obj) {// 곱하기 연산자
            // insert here
            jlb_oper.setText(jbtn_mult.getText());
        } else if (jbtn_div == obj) {// 나누기 연산자
            // insert here
            jlb_oper.setText(jbtn_div.getText());
        }
